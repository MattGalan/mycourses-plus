function onPageLoadHideNavElements() {
    // Get the header div.
    var navBar = $("body > header > nav > d2l-navigation > d2l-navigation-main-footer > div > div")
...
function injectHideMenu() {
    ...
    navBar.children().each(function(i, navDiv) {
        ...
        if (!excludedNavBars.includes(navText)) {
            ...
            var menuItemHtml = '<d2l-menu-item text="'+ navText+'" class="d2l-navigation-s-menu-item-root" id="'+ id + '" role="menuitem" tabindex="0" aria-disabled="false" first="true"></d2l-menu-item>'
